...
public class ItemController {
	...
	public ModelAndView menuInfo(HttpServletRequest request, String itemId,
		...
		if (itemId == null) {
			...
			switch(anId.substring(0, 1).toUpperCase()){
				case "S": view.addObject("item_size","소형"); break;
				case "M": view.addObject("item_size","중형"); break;
				case "L": view.addObject("item_size","대형"); break;
				case "X": view.addObject("item_size","특별사이즈"); break;
			}
			switch(anId.substring(1, 2)){
				case "1": view.addObject("item_cream","생크림"); break;
				case "2": view.addObject("item_cream","초코크림"); break;
			}
			switch(anId.substring(2, 3).toUpperCase()){
				case "S":view.addObject("item_fruit1","딸기");break;
				case "B":view.addObject("item_fruit1","바나나");break;
				case "G":view.addObject("item_fruit1","포도");break;
			}	
			switch(anId.substring(3, 4).toUpperCase()){
				case "S":view.addObject("item_fruit2","딸기");break;
				case "B":view.addObject("item_fruit2","바나나");break;
				case "G":view.addObject("item_fruit2","포도");break;
			}
			switch(anId.substring(4, 5).toUpperCase()){
				case "S":view.addObject("item_fruit3","딸기");break;
				case "B":view.addObject("item_fruit3","바나나");break;
				case "G":view.addObject("item_fruit3","포도");break;
			}
	...
	public String menuListMng(Model model) {
		...
		for(int i = 0, n = list.size(); i < n; i++){
			...
			switch( item.getItemId().substring(0,1) ){
				case "S" : collection.get(0).add(item); break;
				case "M": collection.get(1).add(item); break;
				case "L" : collection.get(2).add(item); break;
				default   : collection.get(3).add(item); break;
			}
		}
    ...
    public String itemInsertProc(@RequestParam Map<String,String> param,HttpServletRequest request, Model model) {
    ...
    public String itemModifyProc(@RequestParam Map<String,String> param, String itemId, 
