...
<body>
	<div>
		<h1 align="center">관리자 boardUpdateForm</h1>
		
	
		<form action="mngboardUpdate.do" method="post">
			...
			<table border="0" width="90%" align="center">			
				...
				<tr>
					<td></td>
					<td align="right">
					<input type="submit" onclick="document.location='mngboardUpdate.do'" value="수정 완료" class="redBtn">
