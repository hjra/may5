...
public class Order {
	...
	public String toString() {
		return "Order [zipCode=" + zipCode + ", sizeCode=" + sizeCode
				+ ", cstId=" + cstId + ", orderDate=" + orderDate
				+ ", sameTimeCount=" + sameTimeCount + ", orderDetailAddress="
				+ orderDetailAddress + ", receiverName=" + receiverName
				+ ", receiverCP=" + receiverCP + ", receiverPhone="
				+ receiverPhone + ", dlvEndDate=" + dlvEndDate
				+ ", noticeComment=" + noticeComment + ", noticeImg="
				+ noticeImg + ", itemId=" + itemId + ", levelCode=" + levelCode
				+ ", stockAmount=" + stockAmount + ", orderAmount="
				+ orderAmount + ", orderCode=" + orderCode + ", payCode="
				+ payCode + ", optionCode=" + optionCode + ", dlvChargeCode="
				+ dlvChargeCode + ", noticeCode=" + noticeCode + ", pointCode="
				+ pointCode + "]";
	}
	...
	public Order(String zipCode, String sizeCode, String cstId, Date orderDate,
			String sameTimeCount, String orderDetailAddress,
			String receiverName, String receiverCP, String receiverPhone,
			Date dlvEndDate, String noticeComment, String noticeImg,
			String itemId, String levelCode, int stockAmount, int orderAmount,
			int orderCode, int payCode, int optionCode, int dlvChargeCode,
			int noticeCode, int pointCode) {
		super();
		this.zipCode = zipCode;
		this.sizeCode = sizeCode;
		this.cstId = cstId;
